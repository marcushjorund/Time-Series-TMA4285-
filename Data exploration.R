...
ccf(percipitation_data[1:n_electricity], electricity_data, lag.max = 50)
...
#electricity data
delectricity_data <- diff(electricity_data,lag = 1)
...
acf(delectricity_data)
pacf(delectricity_data)
...
acf(ddelectricity_data,  lag.max= 50)
pacf(ddelectricity_data, lag.max = 50)
